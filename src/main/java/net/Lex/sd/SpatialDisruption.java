...
import net.Lex.sd.data.client.provider.ItemGroupSD;

// The value here should match an entry in the META-INF/mods.toml file
@Mod(SpatialDisruption.MOD_ID)
public class SpatialDisruption
{
    ...
    private void enqueueIMC(final InterModEnqueueEvent event)
    {
        ...
        InterModComms.sendTo("sd", "helloworld", () -> { LOGGER.info("Hello world from the MDK"); return "Hello world";});
    }
